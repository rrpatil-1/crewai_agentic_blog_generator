...
st.set_page_config(page_title="Content Research & Writer", page_icon=":robot:", layout="wide")

#title and description
st.title("🤖Content Research & Writer Power by CrewAI")
...
with st.sidebar:
    ...
    temperature = st.slider("Temperature", 0.0, 1.0, 0.5, 0.7)

    # add some spacing
    st.markdown("---")

    #make generate button more prominent in sidebar
    ...
    with st.expander("ℹ How to use this app"):
        ...
        - Adjust the temperature slider to control the creativity of the generated content
        - Click the "Generate Content" button to generate content
...
# footer
st.markdown("---")
st.markdown("Built with CrewAI, Streamlit and Gemini by [CrewAI](https://crewai.com)")
